# Task 3: set app main theming (with references) and create proper landing page and user page after login with siwe / wallet
...
- [x] implement this theme for this app with this prompt
```
<role>
...
```
- [x] Create landing page and user page with this business context:
 - liquprop is a platform that allow property owners to release their property assets as tokenized securities and allow user to invest in them
 - liquprop is having feature that integrate to AI to check the property value and real value based on data on AI and internet (like satellite etc to check antifraud)
 - liquprop is backed up by baseline, so it will protect user from total loss (we guaranteed that assets value will not drop below the baseline and baseline will be protected and increase time by time)
 - integration with uniswap and chainlink
