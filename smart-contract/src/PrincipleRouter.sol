...
/// @title PrincipleRouter
/// @notice Non-upgradeable swap router wrapper
contract PrincipleRouter {
    ...
    function swap(
        RouterInput calldata params
    ) external checkDeadline(params.deadline) {
        ...
        ISwapRouter02.ExactInputSingleParams memory swap_ = ISwapRouter02
